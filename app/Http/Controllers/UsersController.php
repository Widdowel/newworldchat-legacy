    ...
    public function me(Request $request)
    {
        ...
        return response()->json([
            ...
            'announcement' => now()->lt(\Carbon\Carbon::parse('2026-04-18 00:00:00')) ? [
                ...
                'message_fr' => "Chers utilisateurs,\n\nNewWorldChat évolue vers une nouvelle plateforme plus performante et plus complète.\n\nDate de migration : 17 avril 2026\n\n--- Ce qui reste inchangé ---\n- Votre mot de passe reste identique\n- Votre solde LDP sera intégralement converti en NWC, le nouveau token officiel\n- Le minage tap-to-earn reste disponible\n- La messagerie et les appels sont maintenus\n\n--- Les nouveautés ---\n- Nouvelle adresse : newworld.chat\n- Le token LDP devient NWC, bridgeable vers la blockchain Solana\n- Nouveau système de minage avec packs d'énergie\n- Staking : 35 à 60% APY selon le montant\n- Pool de liquidité : 100 à 120% APY\n- Shop e-commerce intégré\n- Appels vidéo améliorés avec programmation et rappels\n- Statuts et stories\n- Portefeuille multi-crypto : SOL, USDC, BNB\n\n--- Boosters et Stakings en cours ---\n- Tous les stakings actifs seront annulés. Votre capital vous sera intégralement restitué avant la migration.\n- Si vous disposez d'un booster actif, un pack d'énergie équivalent vous sera attribué gratuitement sur la nouvelle plateforme.\n\n--- Actions requises ---\n- Si vous utilisez un numéro de téléphone pour vous connecter : vous devez impérativement ajouter une adresse email à votre compte avant le 17 avril. La nouvelle plateforme fonctionne exclusivement avec une adresse email.\n- À partir du 17 avril, connectez-vous sur newworld.chat avec votre adresse email et votre mot de passe actuel.\n- Si vous avez oublié votre mot de passe, utilisez la fonction \"Mot de passe oublié\" sur newworld.chat pour en créer un nouveau.\n- Lors de votre première connexion, vous devrez accepter les nouvelles conditions d'utilisation.\n- Les comptes migrés qui ne se connectent pas dans les 2 mois suivant la migration seront supprimés.\n\nL'ancienne plateforme sera désactivée après la migration.\n\nPour toute question, contactez-nous sur la plateforme.\nNEWWORLD GROUP FZE LLC — Dubai, UAE",
